  ...
  return (
    <Card className="border-dashed">
      <CardContent className="p-space-8 text-center">
        ...
        <Link
          href="/record"
          className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white font-medium px-4 py-2.5 rounded-xl shadow-sm hover:shadow-md transition-all duration-200"
        >
          <svg
            className="h-4 w-4"
            fill="none"
